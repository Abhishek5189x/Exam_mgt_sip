...
/* 				#anouncements {
	...
	-webkit-text-decoration-skip: objects;
		...
		<body>
			<% if(session.getAttribute("currentUser")==null){ response.sendRedirect("login.jsp"); } User user=(User)
														...
														<div class="row justify-content-between">
															<div class="col">
																<p class="mb-0 phone"><span
																		class="fa fa-pagelines"></span> <a
																		href="index.php" style="font-size: 2.5vh;text-decoration:none">K.S. School Of Business
																		Management</a></p>
															</div>
