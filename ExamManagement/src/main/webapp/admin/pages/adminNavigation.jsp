 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="faculty_data.jsp"><i class="fa fa-book"></i> Facultys</a>
                    </li>
                    ...
                    <li>
                                <a href="uploadMarkApr.jsp"><i class="fa fa-check-square"></i> Upload Marks Approval</a>
                    </li>
                    ...
                    <li>
                        <a href="profile.php"><i class="fa fa-laptop"></i> Admin Details</a>
                    </li>
